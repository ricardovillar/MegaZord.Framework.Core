...
namespace MegaZord.Framework.Helpers {
    public class MZHelperCrypto {
        private static byte[] _salt = Encoding.ASCII.GetBytes("MZFramework 2013 :) - Etiam quis enim id orci congue commodo. Nunc ut libero sed felis");
            ...
            using (var key = new Rfc2898DeriveBytes(sharedSecret, _salt)) {
                ...
                using (var aesAlg = Aes.Create()) {
                    ...
                    using (MemoryStream msEncrypt = new MemoryStream()) {
                        ...
                        outStr = UrlTokenEncode(msEncrypt.ToArray());
        ...
        private static string DecryptString(string cipherText, string sharedSecret) {
            ...
            try {
                ...
                using (var key = new Rfc2898DeriveBytes(sharedSecret, _salt)) {
                    ...
                    inputByteArray = UrlTokenDecode(cipherText);
